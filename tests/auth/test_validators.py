...
from dj.auth.validators import get_password_validators, get_username_validators, \
...
class PasswordLengthValidatorTests(TestCase):
    ...
    def test_validate_with_min_length_and_max_length(self):
        validate_between_8_and_100_characters = PasswordLengthValidator(min_length=8, max_length=100)
        ...
        self.assertIsNone(validate_between_8_and_100_characters("l_dfj$34#lkjfs434_*sl3"))
        self.assertIsNone(validate_between_8_and_100_characters("a" * 100))

    def test_validate_just_with_max_length(self):
        validate_at_most_10_characters = PasswordLengthValidator(min_length=None, max_length=10)
    ...
    def test_validate_just_with_min_length(self):
        validate_at_least_5_characters = PasswordLengthValidator(min_length=5, max_length=None)
    ...
    def test_equal_method(self):
        validate_between_5_and_32_characters = PasswordLengthValidator(min_length=5, max_length=32)
        validate_at_most_32_characters = PasswordLengthValidator(min_length=None, max_length=32)
        validate_at_least_5_characters = PasswordLengthValidator(min_length=5, max_length=None)
        ...
        validate_between_6_and_32_characters = PasswordLengthValidator(min_length=6, max_length=32)
        validate_between_5_and_30_characters = PasswordLengthValidator(min_length=5, max_length=30)
        validate_between_6_and_30_characters = PasswordLengthValidator(min_length=6, max_length=30)

        self.assertNotEqual(validate_between_5_and_32_characters, validate_between_6_and_32_characters)
        self.assertNotEqual(validate_between_5_and_32_characters, validate_between_5_and_30_characters)
        self.assertNotEqual(validate_between_5_and_32_characters, validate_between_6_and_30_characters)

        self.assertEqual(validate_between_5_and_32_characters, PasswordLengthValidator(min_length=5, max_length=32))
        self.assertEqual(validate_at_least_5_characters, PasswordLengthValidator(min_length=5, max_length=None))
        self.assertEqual(validate_at_most_32_characters, PasswordLengthValidator(min_length=None, max_length=32))
